...
export default function TaskColumn({ title, colorClass, completed, total, children, onAddTaskClick }) {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="mt-auto pt-4">
        ...
        <button
          ...
          className="flex items-center gap-2 text-gray-600 font-bold text-sm hover:text-gray-900 transition group"
        >
          <div
